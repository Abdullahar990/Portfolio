...
const SkillsSection = ({ isLoaded }) => {
    const skills = [
        ...
        { name: 'C++', level: 80, icon: <SiCplusplus className="w-5 h-5 text-white" />, color: 'from-blue-600 to-indigo-400' },
        { name: 'OpenCV', level: 84, icon: <SiOpencv className="w-5 h-5 text-white" />, color: 'from-indigo-500 to-purple-400' },
        { name: 'React.js', level: 95, icon: <FaCode className="w-5 h-5 text-white" />, color: 'from-blue-500 to-cyan-400' },
